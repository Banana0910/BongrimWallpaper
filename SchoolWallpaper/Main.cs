    ...
    public partial class Main : Form
    {
        ...
        private void set_subject(int lesson, string subject, string teacher) {
            ...
            int center_y = (class_y_bar.Maximum - class_y_bar.Value) - ((TextRenderer.MeasureText(subject, subject_title).Height + 
                TextRenderer.MeasureText(subject, subject_title).Height + 
                TextRenderer.MeasureText("(12:00 ~ 12:00)", time_str).Height) / 2);
            ...
            center_x = class_x_bar.Value - (TextRenderer.MeasureText("(12:00 ~ 12:00)", time_str).Width / 2);

            g.DrawString("(12:00 ~ 12:00)", time_str, tiny_color, new RectangleF(center_x,center_y,image.Width,image.Height));

            //저장 및 적용
            image.Save("test.png", System.Drawing.Imaging.ImageFormat.Png);
            pictureBox1.ImageLocation = "./test.png";
            set_wallpaper(pictureBox1.ImageLocation);
        }
